...
class RecommendedAdapter(private val listOfItems: List<itemsDataClass>,
                         var onItemClick: ((itemsDataClass) -> Unit)? = null) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.recommended_adapter_layout, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onItemClick?.invoke(listOfItems[position])
        }
    }
}